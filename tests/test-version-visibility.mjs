...
if (manifest.production !== '2.5') {
  throw new Error('Production version must explicitly remain v2.5');
}
...
console.log('PASS: v2.5 stays production and hidden alternates remain direct-link only');
